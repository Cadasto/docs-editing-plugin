...
- **[`references/style-guide.md`](references/style-guide.md)**, the house style: voice and grammatical person per context, sentence economy, terminology discipline, inclusive language, structure, Markdown mechanics. Names the enforcing tool for every mechanical rule.
