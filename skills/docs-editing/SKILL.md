...
| Set up prose linting in a repo | none | `/docs-lint-setup` |
| Which document kind is this? | none | this skill → `references/doc-types.md` |
| May I write this claim? | none | this skill → `references/claims-and-evidence.md` |
